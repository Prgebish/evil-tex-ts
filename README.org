...
- =cic= (change inner command)
  ...
  _*Before:*_ =\textbf{hel|lo}=

  _*Press*_ =cic=

  _*After:*_ =\textbf{|}=

  _*Before:*_ =\tex|tbf{hello}=
  ...
  _*Before:*_ =s|ome text \textbf{hello}=

  _*Press*_ =cic=

  _*After:*_ =some text \textbf{|}=
...
- =mtS= (change section type)
  ...
  _*Press*_ =mtS=, select =subsection= from prompt
...
- =ysiwe= (surround word with environment)
  ...
  _*Press*_ =ysiwe=, then type =equation=
...
- =cseea= (change environment to align)
  ...
  _*Press*_ =cs= (change surround), =e= (old: environment), =e= (new: environment keymap), =a= (align)
